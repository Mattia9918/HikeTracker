  ...
  return (
    <>
      {(msg.message === "You have been logged out!" ||
        (user && msg.message === `Welcome ${user.username}!`)) && (
  ...
  return (
    <>
      <Row id="infocontainer" className="mt-4" align="center">
        <Col>
          <div>
            <i className="bi bi-geo-alt" style={{ fontSize: size }} />
          </div>
        ...
        <Col>
          <div>
            <i className="bi bi-stopwatch" style={{ fontSize: size }} />
          </div>
        ...
        <Col>
          <div>
            <i className="bi bi-cursor" style={{ fontSize: size }} />
          </div>
      ...
      <Row className="mt-4">
        {!props.open ? (
          <BiChevronDown fontSize="2.2rem" />
        ) : (
          <BiChevronUp fontSize="2.2rem" />
        )}
      </Row>
    </>
  );
  ...
  return (
    <>
      ...
      <ListGroup className="mb-3">
        <ListGroupItem>
          {(start.type === "hut" && (
            <AiOutlineHome style={{ marginTop: "-3px" }} />
          )) ||
            (start.type === "parking" && (
              <RiParkingBoxLine style={{ marginTop: "-3px" }} />
            )) || <FiMapPin />}
          {"  "}
          <b>{startText}</b>
          {start.city}, {start.province}
      ...
      {props.user && props.user.role === "hiker" && (
        <StatusButton
          ...
          hike={props.hike}
          setShowStatusModal={props.setShowStatusModal}
        />
      )}
    </>
  );
